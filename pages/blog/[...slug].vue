<template>
        <div class="md:mt-16">
                <article class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 dark:text-white">
                        <div>
                                <img class="h-48 md:h-full w-full object-cover" :src="data.img" alt="">
                        </div>

                        <div class="prose prose-lg prose-img:rounded-xl prose-headings:no-underline max-w-3xl mx-auto p-16 dark:prose-invert">
                                <div class="flex flex-col md:flex-row justify-between md:items-center">
                                        <div class="md:m-4 flex flex-row items-center">
                                                ...
                                                <p class="text-normal ml-4 text-gray-800 dark:text-white">{{data.author.name}}</p>                                                              
                                        </div>
